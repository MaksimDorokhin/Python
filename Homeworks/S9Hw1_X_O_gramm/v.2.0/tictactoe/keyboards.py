...
def difficulty_select_keyboard():
    buttons = [
        types.InlineKeyboardButton(text="Нуб" + emoji.emojize(':nerd_face:'), callback_data="cpu_noob"),
        types.InlineKeyboardButton(text="Сверхразум" + emoji.emojize(':robot:'), callback_data="cpu_god"),
    ]
